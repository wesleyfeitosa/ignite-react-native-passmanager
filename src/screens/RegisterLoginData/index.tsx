...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    try {
      ...
      const currentLoginData: FormData[] = data ? JSON.parse(data) : [];

      const loginData = [...currentLoginData, newLoginData];

      await AsyncStorage.setItem('@passmanager:logins', JSON.stringify(loginData));
      reset();
    } catch (error) {
